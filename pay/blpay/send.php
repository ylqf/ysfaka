...
$payconf = $payDao->checkAcp('blpay');
//组装支付参数
$paydata = [
    'pid' => $payconf['userid'],
    'type' => $paycode,
    'out_trade_no' => $order['orderid'],
    'notify_url'   => $payDao->urlbase.$_SERVER['HTTP_HOST'].'/pay/blpay/notify.php',
    'return_url'   => $payDao->urlbase.$_SERVER['HTTP_HOST'].'/pay/blpay/return.php',
    'name'   => $order['oname'],
    'money'  => $order['cmoney'],
    //'money'  => 0.01,
...
$payDao->res->redirect('http://pay.blyzf.cn/submit.php?'.$canshu);